...
class UYGULAMA(object):
    ...
    def vakitdenetle(self):
        ...
        if saat == self.vakitler[0]:
            Thread(target=self.uyari, args=(u"Ezan Vakti - Uyarı", u"İmsak Vakti !","kaynaklar"+os.sep+"imsak.mp3")).start()
            ...
            Thread(target=self.uyari, args=(u"Ezan Vakti - Uyarı", u"Öğle Vakti !", "kaynaklar"+os.sep+"ogle.mp3")).start()
            ...
            Thread(target=self.uyari, args=(u"Ezan Vakti - Uyarı", u"İkindi Vakti !", "kaynaklar"+os.sep+"ikindi.mp3")).start()
            ...
            Thread(target=self.uyari, args=(u"Ezan Vakti - Uyarı", u"Akşam Vakti !", "kaynaklar"+os.sep+"aksam.mp3")).start()
            ...
            Thread(target=self.uyari, args=(u"Ezan Vakti - Uyarı", u"Yatsı Vakti !", "kaynaklar"+os.sep+"yatsi.mp3")).start()
